document.addEventListener ('DOMContentLoaded', function () {
  const fetch_id = document.getElementById('ochreContainer').getAttribute( 'data-uuid'); //Retrieves the uuid once the HTML has loaded completely.
  const ochre_url = 'https://ochre.lib.uchicago.edu/ochre?uuid=';
  var display = document.getElementById('ochreContainer'); //Stores the intended 'display' element as a variable.
